...
class Footer extends Component {
    ...
    render() {
        return (
            <FooterContainer>
                <span style={{marginLeft:'18%',fontSize:'1.125rem'}}>Questions?Call <Link>0740756210</Link></span>
                <div className="footer-content">
                    ...
                    <ul>
                        ...
                        <li><Link>Reddem Gift Cards</Link></li>
                ...
                <span style={{marginLeft:'15%',fontSize:'0.9rem'}}>Netflix Kenya</span>
            </FooterContainer>
        )
    }
}
